...
# Date:    2026-05-11
# Time:    09:30:00
# Compiled on: 2026-05-11 09:30:00
# Description: V22.5 - Thread Stability Fix + Silence Threshold
# **************************************************************************
...
# --- 1. BOOT HEADER ---
print("\n" + "="*60)
print("PROJECT: TIM'S THEREMIN (V22.5)")
print("COMPILE DATE: 2026-05-11 09:30:00")
print("STATUS: CORE-LINK STABILIZED...")
print("="*60 + "\n")
...
# Start thread with state explicitly passed as a tuple
...
while True:
    ...
    # 1. Inputs (Inversions Applied: L-X and L-Y)
    raw_lx = 65535 - joy_lx.read_u16() 
    raw_ly = 65535 - joy_ly.read_u16() 
    ...
    # 3. Volume Targets with Silence Gate
    t_v_l = (raw_ly / 65535) * 28000 if raw_ly > gate else 0
    t_v_r = (raw_ry / 65535) * 28000 if raw_ry > gate else 0
    ...
    # 5. Visuals (RGB LED follows Joysticks)
