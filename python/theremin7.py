...
state = {
    ...
    "smoothing": 0.12,          # Snappier response
...
def audio_worker(shared_state):
    import math
    import utime
    SAMPLE_RATE = 44100  # Hi-Fi Sample Rate
...
while True:
    ...
    t_v_l = ((dist_l / 32767) * 34000) if dist_l > gate else 0
    t_v_r = ((dist_r / 32767) * 34000) if dist_r > gate else 0
